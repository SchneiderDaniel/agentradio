...
```bash
python .gemini/skills/flask_blogs-translation-manager/scripts/po_manager.py flask_blogs/flask_planhead/app/translations/de/LC_MESSAGES/messages.po --repair
```

### 2. Remove Fuzzy Flags
Required if `pybabel compile` skips entries marked as fuzzy.
```bash
python .gemini/skills/flask_blogs-translation-manager/scripts/po_manager.py flask_blogs/flask_planhead/app/translations/de/LC_MESSAGES/messages.po --unfuzzy
```

### 3. Restore Header
Fixes compilation errors due to missing or corrupted PO headers.
```bash
python .gemini/skills/flask_blogs-translation-manager/scripts/po_manager.py flask_blogs/flask_planhead/app/translations/de/LC_MESSAGES/messages.po --header
```
